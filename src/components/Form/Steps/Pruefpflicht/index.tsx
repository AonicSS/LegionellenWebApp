...
const Pruefpflicht = () => {
	...
	switch (currentSubStep) {
		...
		case 1: {
			...
			return (
				<Radio questionTextOverride={"Hat die Liegenschaft eine zentrale Warmwasser-Erwärmung?"}></Radio>
			);
		}
		case 2:{
			return (
				<Radio questionTextOverride={"Sind an die zentrale Warmwasser-Erwärmung drei oder mehr Wohnungen angeschlossen, von denen mindestens eine vermietet ist?"}></Radio>
			);
		}
		case 3:{
			return (
				<Radio questionTextOverride={"Ist die Trinkwasseranlage mit einem Wasserspeicher mit mehr als 400 Litern verbunden oder hat mehr als 3 Liter im Leitungssystem?"}></Radio>
			);
		}
